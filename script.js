...
// let voice = new Audio('/sounds/219069__annabloom__click1.wav')
...
// btns.forEach( btn => {
//     btn.addEventListener('click',() => handleClick(btn.getAttribute("data-key")));
// });

// addEventListener('keypress', (e) => handleClick(e.key));
...
//     }
//     voice.play();
//     let targetElement = [...btns].filter(btn => btn.getAttribute['data-key'] == myKey)
